...
class Test_02(object):
    ...
    def run(self):
        ...
        # Simulate streaming the entries to our processor => In reverse order
        indexList = reversed(range(len(webLogs)))
